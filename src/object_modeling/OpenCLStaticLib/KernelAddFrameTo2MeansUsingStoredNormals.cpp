...
const std::string KernelAddFrameTo2MeansUsingStoredNormals::kernel_name = "KernelAddFrameTo2MeansUsingStoredNormals";

KernelAddFrameTo2MeansUsingStoredNormals::KernelAddFrameTo2MeansUsingStoredNormals(OpenCLAllKernels & opencl_kernels)
...
void KernelAddFrameTo2MeansUsingStoredNormals::runKernel(
	...
	)
{
	try {
        ...
        kernel_.setArg(kernel_arg++, buffer_normals_1.getBuffer());
        kernel_.setArg(kernel_arg++, buffer_mean_2.getBuffer());
        kernel_.setArg(kernel_arg++, buffer_count_2.getBuffer());
        kernel_.setArg(kernel_arg++, buffer_normals_2.getBuffer());
