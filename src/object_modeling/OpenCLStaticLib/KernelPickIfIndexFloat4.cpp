...
const std::string KernelPickIfIndexFloat4::kernel_name = "KernelPickIfIndexFloat4";

KernelPickIfIndexFloat4::KernelPickIfIndexFloat4(OpenCLAllKernels & opencl_kernels)
...
void KernelPickIfIndexFloat4::runKernel(cl::Buffer & running_buffer, cl::Buffer & possible_index, cl::Buffer & possible_values, int index, size_t size)
{
	try {
		// convert args
