...
const std::string KernelExtractVolumeSliceFloat4Length::kernel_name = "KernelExtractVolumeSliceFloat4Length";

KernelExtractVolumeSliceFloat4Length::KernelExtractVolumeSliceFloat4Length(OpenCLAllKernels & opencl_kernels)
	: cl_(opencl_kernels.getCL()),
	kernel_(opencl_kernels.getKernel(kernel_name))
{
}

void KernelExtractVolumeSliceFloat4Length::runKernel(
	VolumeBuffer & volume,
