...
const std::string KernelRenderPointsAndNormals::kernel_name = "KernelRenderPointsAndNormals";

KernelRenderPointsAndNormals::KernelRenderPointsAndNormals(OpenCLAllKernels & opencl_kernels)
...
void KernelRenderPointsAndNormals::runKernel(
