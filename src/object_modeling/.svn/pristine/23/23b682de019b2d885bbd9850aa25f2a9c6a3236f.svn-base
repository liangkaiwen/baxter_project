...
const std::string KernelAddFrameTo2MeansUsingNormals::kernel_name = "KernelAddFrameTo2MeansUsingNormals";

KernelAddFrameTo2MeansUsingNormals::KernelAddFrameTo2MeansUsingNormals(OpenCLAllKernels & opencl_kernels)
...
void KernelAddFrameTo2MeansUsingNormals::runKernel(
