...
public:
	...
	void GenerateSurface(const T* ptScalarField, const float * ptWeightField, T tIsoLevel, unsigned int nCellsX, unsigned int nCellsY, unsigned int nCellsZ, float fCellLengthX, float fCellLengthY, float fCellLengthZ);
...
//protected:
	...
	// peter: validity
	bool* m_pboolValidity;

	// Peter: moved protected down here
protected:
	...
	// peter: also a buffer for weights
	const float * m_ptWeightField;
