...
const std::string KernelComputeNormalVolume::kernel_name = "KernelComputeNormalVolume";

KernelComputeNormalVolume::KernelComputeNormalVolume(OpenCLAllKernels & opencl_kernels)
...
void KernelComputeNormalVolume::runKernel(
    VolumeBuffer & volume,
    VolumeBuffer & result
	)
{
