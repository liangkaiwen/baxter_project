...
const std::string KernelComputeNormalVolumeWithWeightsUnnormalized::kernel_name = "KernelComputeNormalVolumeWithWeightsUnnormalized";

KernelComputeNormalVolumeWithWeightsUnnormalized::KernelComputeNormalVolumeWithWeightsUnnormalized(OpenCLAllKernels & opencl_kernels)
...
void KernelComputeNormalVolumeWithWeightsUnnormalized::runKernel(
    VolumeBuffer & volume,
