...
// ************************
    ...
    public:
        ...
        IVCAM_STATUS Init(char *rgbCam, int cw, int ch, char *depthCam, int dw, int dh);
    	...
    	//return: TIVCAM_STATUS
        IVCAM_STATUS  MapDepthToColorCoordinates(IN unsigned int width, IN unsigned int height, IN int16_t* pSrcDepth, OUT float* pDestUV, IN bool isUVunitsRelative = true);
